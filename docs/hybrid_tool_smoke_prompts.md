...
23) Call `get_library_resources` with arguments `{ "type": "playlists", "ids": "<libraryPlaylistIdFromStep17Or37>" }`.
24) Call `get_library_resource` with arguments `{ "type": "albums", "id": "<libraryAlbumIdFromStep19>" }`.
25) Call `get_library_relationship` with arguments `{ "type": "playlists", "id": "<libraryPlaylistIdFromStep17Or37>", "relationship": "tracks", "limit": 5 }`.
26) Call `get_library_multi_by_type_ids` with arguments `{ "ids": { "library-songs": "<librarySongIdFromStep18>", "library-albums": "<libraryAlbumIdFromStep19>" } }`.
...
38) Call `add_playlist_tracks` with arguments `{ "playlistId": "<playlistIdFromStep37>", "trackIds": "203709340,203709341" }`.
...
41) Call `add_favorites` with arguments `{ "ids": "203709340", "resourceType": "songs" }` and confirm the tool surfaces a 405 limitation if it occurs.
