...
struct GetRecentlyPlayedTracksCommand: AsyncParsableCommand, ToolRunnableCommand {
    static let configuration = CommandConfiguration(
        commandName: "get-recently-played-tracks",
        abstract: "Fetch recently played tracks."
    )
    ...
    func run() async throws {
        ...
        try await runTool(toolName: "get_recently_played_tracks", arguments: args)
    }
}
