...
struct GetHeavyRotationCommand: AsyncParsableCommand, ToolRunnableCommand {
    static let configuration = CommandConfiguration(
        commandName: "get-heavy-rotation",
        abstract: "Fetch heavy rotation history."
    )
    ...
    func run() async throws {
        ...
        try await runTool(toolName: "get_heavy_rotation", arguments: args)
    }
}
