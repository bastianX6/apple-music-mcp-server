...
struct GetRecentlyPlayedStationsCommand: AsyncParsableCommand, ToolRunnableCommand {
    static let configuration = CommandConfiguration(
        commandName: "get-recently-played-stations",
        abstract: "Fetch recently played radio stations."
    )
    ...
    func run() async throws {
        ...
        try await runTool(toolName: "get_recently_played_stations", arguments: args)
    }
}
