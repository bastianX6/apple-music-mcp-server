...
struct GetCatalogSongsCommand: AsyncParsableCommand, ToolRunnableCommand {
    static let configuration = CommandConfiguration(
        commandName: "get-catalog-songs",
        abstract: "Fetch catalog songs by ids. Uses user storefront when available."
    )
    ...
    func run() async throws {
        ...
        try await runTool(toolName: "get_catalog_songs", arguments: args)
    }
}
