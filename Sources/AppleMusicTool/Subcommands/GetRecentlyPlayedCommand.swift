...
struct GetRecentlyPlayedCommand: AsyncParsableCommand, ToolRunnableCommand {
    static let configuration = CommandConfiguration(
        commandName: "get-recently-played",
        abstract: "Fetch recently played content."
    )

    @OptionGroup var global: GlobalOptions

    @Option(name: .customLong("types"), help: "Filter types.")
    var types: String?

    @Option(name: .customLong("limit"), help: "Limit (1-100, default 10).")
    var limit: Int?
    ...
    func run() async throws {
        ...
        try await runTool(toolName: "get_recently_played", arguments: args)
    }
}
