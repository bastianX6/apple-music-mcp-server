...
struct GetLibraryAlbumsCommand: AsyncParsableCommand, ToolRunnableCommand {
    static let configuration = CommandConfiguration(
        commandName: "get-library-albums",
        abstract: "Fetch user's library albums."
    )
    ...
    func run() async throws {
        ...
        try await runTool(toolName: "get_library_albums", arguments: args)
    }
}
