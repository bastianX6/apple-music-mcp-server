...
struct GetLibraryArtistsCommand: AsyncParsableCommand, ToolRunnableCommand {
    static let configuration = CommandConfiguration(
        commandName: "get-library-artists",
        abstract: "Fetch user's library artists."
    )
    ...
    func run() async throws {
        ...
        try await runTool(toolName: "get_library_artists", arguments: args)
    }
}
